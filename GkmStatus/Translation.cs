    ...
    public static class I18n
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
        {
            ["日本語"] = new Dictionary<string, string>
            {
                ...
                ["Button_ModeNote"] = "Discordの仕様により自分からは確認できません",
                ...
                ["Update_NotificationBody"] = "新しいバージョン {0} が公開されています。\nクリックしてダウンロードページを開きます。",
            ...
            ["English"] = new Dictionary<string, string>
            {
                ...
                ["Button_ModeNote"] = "Only visible to others (Discord limitation)",
                ...
                ["Status_Disconnected_Auto"] = "Disconnected\n(Auto-connect enabled)",
